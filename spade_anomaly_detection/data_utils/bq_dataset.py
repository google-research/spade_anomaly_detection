...
# TODO(b/333154677): Investigate using BigQueryReadClient with one generator per
#  stream.
...
def convert_series_to_tensor_dictionary(
  ...
  """
  if with_mask:
    # TODO(b/333154677): Check performance to see if using null mask is faster.
...
# TODO(b/333154677): Make this cleaner and more dynamic.
...
def _get_output_from_df_iterator(
  ...
  """
  # TODO(b/333154677): Investigate more performant ways to do this.
  data_frame_cache = []
  cur_rows = 0
...
def get_dataset_and_metadata_for_table(
  ...
  # TODO(b/333154677): Refactor the code so that this extra call is not needed.
